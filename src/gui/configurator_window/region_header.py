...
def regionHeader():
    ...
    with dpg.collapsing_header(label="Image regions", default_open=True):
        ...
        with dpg.tree_node(label="Ellipse"):
            ...
            with dpg.group(horizontal=True):
                dpg.add_input_int(label="X", min_value=0, default_value=20, width=UI_CONSTS.W_NUM_INP_TWO_COL, tag="ellipse_x_pos")
                dpg.add_input_int(label="Y", min_value=0, default_value=50, width=UI_CONSTS.W_NUM_INP_TWO_COL, tag="ellipse_y_pos")
            
            dpg.add_spacer(height=5)
            dpg.add_text("Ellipse size")
            with dpg.group(horizontal=True):
                dpg.add_input_int(label="W", min_value=1, default_value=10, width=UI_CONSTS.W_NUM_INP_TWO_COL, tag="ellipse_width")
                dpg.add_input_int(label="H", min_value=1, default_value=5, width=UI_CONSTS.W_NUM_INP_TWO_COL, tag="ellipse_height")
        ...
        with dpg.tree_node(label="Box"):
            ...
            with dpg.group(horizontal=True):
                dpg.add_input_int(label="X", min_value=0, default_value=40, width=UI_CONSTS.W_NUM_INP_TWO_COL, tag="box_x_pos")
                dpg.add_input_int(label="Y", min_value=0, default_value=10, width=UI_CONSTS.W_NUM_INP_TWO_COL, tag="box_y_pos")

            dpg.add_spacer(height=2.5)
            dpg.add_text("Box size")
            with dpg.group(horizontal=True):
                dpg.add_input_int(label="W", min_value=1, default_value=30, width=UI_CONSTS.W_NUM_INP_TWO_COL, tag="box_width")
                dpg.add_input_int(label="H", min_value=1, default_value=15, width=UI_CONSTS.W_NUM_INP_TWO_COL, tag="box_height")
